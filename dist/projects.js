  ...
  const projectCard = (project, index) => {
    ...
    return `
      <details class="project-card" data-project-card>
        <summary>
          <div class="project-cover"><img src="${esc(project.hero)}" alt="${esc(project.heroAlt)}"><span>${esc(project.achievement)}</span></div>
        ...
        <div class="project-case-study">
          ...
          <button class="project-video" type="button" disabled>${esc(project.videoLabel)} ↗</button>
        </div>
      </details>`;
  };
